...
.Key = .IV = [Text.Encoding]::ASCII.GetBytes("JuBsbsmP")
...
Original: 	rial, ree, is_activated: 1, emained_seconds: 0
...
Triple failover chain: oscdn.com -> wangxutech.com -> apsapp.cn
...
+-- files/passport.userinfo   <- Forged license
